...
<head>
   ...
   <link rel="stylesheet" href="css/style.css">
    ...
    <!-- Incluindo o Chart.js para gráficos -->
        ...
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block sidebar">
                <div class="position-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="adicionar-agente.html">
                                <i class="bi bi-shield-lock"></i>
                                Adicionar Agente da Lei
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-4 main-content">
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p><strong>Nome:</strong> João Admin</p>
                                    <p><strong>Email:</strong> admin@exemplo.com</p>
                                    <p><strong>Último login:</strong> 20/04/2025</p>
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nome" value="João Admin">
                                        </div>
                                        <div class="mb-3">
                                            <label for="email" class="form-label">Email</label>
                                            <input type="email" class="form-control" id="email" value="admin@exemplo.com">
                                        </div>
                                        <div class="mb-3">
                ...
                <div id="relatorios">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <h5 class="card-title">Relatório de Denúncias</h5>
                ...
                <div id="usuarios">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-info btn-sm"><i class="bi bi-pencil"></i> Editar</button>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-warning">Suspenso</span></td>
                                    <td>
                                        <button class="btn btn-info btn-sm"><i class="bi bi-pencil"></i> Editar</button>
                                        <button class="btn btn-danger btn-sm"><i class="bi bi-trash"></i> Excluir</button>
                                    </td>
                    ...
                    <button class="btn btn-primary btn-sm mt-3"><i class="bi bi-plus-circle"></i> Adicionar Usuário</button>
                </div>
